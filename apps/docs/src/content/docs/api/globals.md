---
title: "Inheron Engine API Reference"
---
...
- [CronicaViva](classes/CronicaViva.md)
- [Database](classes/Database.md)
- [EffectsManager](classes/EffectsManager.md)
...
- [RespawnManager](classes/RespawnManager.md)
- [Room](classes/Room.md)
- [SkillManager](classes/SkillManager.md)
- [Spawner](classes/Spawner.md)
- [StatCalculator](classes/StatCalculator.md)
- [WorldFactory](classes/WorldFactory.md)

## Interfaces

- [CharacterCreationData](interfaces/CharacterCreationData.md)
- [Class](interfaces/Class.md)
- [CombatParticipant](interfaces/CombatParticipant.md)
- [CombatRound](interfaces/CombatRound.md)
- [DerivedStats](interfaces/DerivedStats.md)
- [Exit](interfaces/Exit.md)
- [ICombatAction](interfaces/ICombatAction.md)
- [ICombatResult](interfaces/ICombatResult.md)
- [IEvent](interfaces/IEvent.md)
- [IEventLog](interfaces/IEventLog.md)
- [IStatusEffect](interfaces/IStatusEffect.md)
- [Quest](interfaces/Quest.md)
- [QuestObjective](interfaces/QuestObjective.md)
- [Race](interfaces/Race.md)
- [SkillDef](interfaces/SkillDef.md)
- [SkillResult](interfaces/SkillResult.md)
- [SpawnVariant](interfaces/SpawnVariant.md)
- [Stats](interfaces/Stats.md)
- [StoryArc](interfaces/StoryArc.md)
